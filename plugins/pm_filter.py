    ...
    if not spoll:
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                await message.reply_text(text=f"△ 𝙷𝚎𝚢 {message.from_user.first_name} 😎,\n\nYour Request has been sent successfully sent to our Admins!\nPlease wait for some time !\nWe will upload it as soon as possible.\n\n➟ 📝𝘾𝙤𝙣𝙩𝙚𝙣𝙩 𝙣𝙖𝙢𝙚 : {search}\n➟ 👮𝙍𝙚𝙦𝙪𝙚𝙨𝙩𝙚𝙙 𝘽𝙮 : {message.from_user.first_name}\n\n༺ @Tmaadda ༻\n\n🦋・‥☆𝘼𝘿𝙈𝙞𝙉 𝙨𝙪𝙥𝙥𝙤𝙧𝙩☆‥・🦋\n╰┈➤・☆ @Tma_SupportBot\n╰┈➤・☆ @TMABackup",reply_markup=InlineKeyboardMarkup([InlineKeyboardButton("✪ Updates Channel ✪", url="https://t.me/Tmaadda"), InlineKeyboardButton("✪ Backup Channel ✪", url="https://t.me/Tmabackup"), InlineKeyboardButton("✪ Main Ch- ✪", url="https://t.me/real_MoviesAdda2")],[InlineKeyboardButton("╚»♥️Thank u MoviesAdda™♥️«╝", callback_data="close_data")]]))
